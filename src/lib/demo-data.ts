...
export const demoAnalysis: AnalysisResult = {
  ...
  career_paths: [
    {
      ...
      best_for:
        "Maya if she wants creative ownership with clear metrics and doesn't want to manage a large team yet.",
      tradeoff:
    ...
    },
    {
      ...
      best_for:
        "Maya if she wants variety, fast iteration cycles, and direct revenue attribution.",
      tradeoff:
    ...
    },
    {
      ...
      best_for:
        "Maya if she wants closer proximity to product decisions and a clearer path toward senior strategy roles.",
      tradeoff:
  ...
  avoid_roles: [
    {
      role_type: "Large Enterprise Brand Manager",
      reason:
    ...
    {
      role_type: "Pure Paid Media / PPC Specialist",
      reason:
    ...
    {
      role_type: "Field Marketing / Events Coordinator",
      reason:
  ...
  action_plan: [
    {
      step: 1,
      title: "Audit and select 2 portfolio pieces",
      details:
    ...
    {
      step: 3,
      title: "Identify 15 target companies",
      details:
    ...
    {
      step: 5,
      title: "Run a 2-hour skills gap audit",
      details:
    ...
    {
      step: 6,
      title: "Fill the most common skills gap",
      details:
    ...
    {
      step: 7,
      title: "Apply to 3 roles — quality over volume",
      details:
  ...
  cv_rewrites: [
    {
      ...
      why_better:
        "The original tells the reader what you were supposed to do. The rewrite tells them what you actually achieved and shows that you understand why it worked. Specificity and causality are the two things that turn a duty into an achievement.",
    },
    {
      before:
      ...
      why_better:
        "\"Collaborated\" and \"supported\" are the weakest verbs on any CV. The rewrite shows scope (4 stakeholders), speed (3 weeks), and impact (22% uplift). It also makes clear you led this rather than contributed to someone else's work.",
    },
  ],
