...
export default async function DashboardPage(){
 ...
 return <div className="mx-auto max-w-5xl">
   <div className="mb-14 flex items-end justify-between gap-6"><div><p className="mb-3 font-mono text-xs uppercase tracking-[.18em] text-primary">Your journeys</p><h1 className="text-4xl md:text-5xl">A log of where you’ve been.</h1><p className="mt-3 text-muted-foreground">Return to an earlier report or begin from where you are now.</p></div><Link href="/new" className="inline-flex h-11 shrink-0 items-center gap-2 rounded-full bg-primary px-5 text-sm font-medium text-white"><Plus className="size-4"/>New analysis</Link></div>
